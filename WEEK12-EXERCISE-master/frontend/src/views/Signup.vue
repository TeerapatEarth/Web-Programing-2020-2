        ...
        <div class="column is-4">
          ...
          <div class="field">
            ...
            <template v-if="$v.username.$error">
              ...
              <p class="help is-danger" v-if="!$v.username.length">
                5 - 20 only
              </p>
            </template>
          </div>
          ...
          <div class="field">
            ...
            <template v-if="$v.mobile.$error">
              ...
              <p class="help is-danger" v-if="!$v.mobile.out">
                out of length
              </p>
            </template>
          </div>
          ...
          <div class="field">
            ...
            <template v-if="$v.first_name.$error">
              ...
              <p class="help is-danger" v-if="!$v.first_name.length">
                out of length
              </p>
            </template>
          </div>
          ...
          <div class="field">
            ...
            <template v-if="$v.last_name.$error">
              ...
              <p class="help is-danger" v-if="!$v.last_name.length">
                out of length
              </p>
            </template>
          </div>
...
function username(value) {
  return !!value.match(/^[a-zA-Z0-9]{5,20}$/);
}
function first_name(value) {
  return !!value.match(/^[a-zA-z]{0,150}$/);
}
function out(value){
